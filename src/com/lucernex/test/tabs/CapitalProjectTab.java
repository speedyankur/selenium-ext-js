...
public class CapitalProjectTab extends com.lucernex.test.core.Test {
	...
	private void setUpExpectedData(){
		expectedMap.put("Name", "QA Captital Project");
		expectedMap.put("Region", "Central");
		expectedMap.put("Portfolio", "Lucernex");
	}
	...
	public void test() throws Exception {
		...
		driver.findElement(By.id("m1_CapitalProject")).click();
		System.out.println("Capital Project Tab opened");
		driver.findElement(By.id("m2_CapitalProject_Details")).click();
		System.out.println("Capital Project-->Details openened");
